...
class Propagation2D:
    ...
    def __init__ (self, z0, theta_0, **kwargs):
        ...
        **kwargs
        ...
        self.n_steps_max = kwargs.get('n_steps_max', 1000000)
        ...
        # Read bottom limit
        limit_bottom = kwargs.get('limit_bottom', None)
        ...
        self.calc_dz_c = calc_calc_dz_c(self.calc_c, -10000, 0, 100000)   #TODO: specify the limits in **kwargs
    ...
    def __generate (self):
        ...
        while i < self.n_steps_max:
            ...
            # Check bottom reflection
                ...
                dx_z_ground = self.calc_der(self.limit_bottom_func, x_new, dx=x_new-x)
            ...
            # a += self.calc_absorption(f, z, calc_T(z), S, calc_pH(z)) * dl / 1e3  # calculate on z_old ## TODO: optimisation - redundant call to calc_T and calc_pH
